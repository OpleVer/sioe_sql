(function() {
    ...
    angular
        .module('sioeSqlApp')
        .controller('PeticionEvaluarController', PeticionEvaluarController);

    PeticionEvaluarController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'DataUtils', 'entity', 'Peticion', 'Origen', 'Peticionario'];

    function PeticionEvaluarController ($timeout, $scope, $stateParams, $uibModalInstance, DataUtils, entity, Peticion, Origen, Peticionario) {
        var vm = this;

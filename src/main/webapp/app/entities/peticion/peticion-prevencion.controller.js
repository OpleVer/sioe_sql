(function() {
    ...
    angular
        .module('sioeSqlApp')
        .controller('PeticionPrevencionController', PeticionPrevencionController);

    PeticionPrevencionController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'DataUtils', 'entity', 'Peticion', 'Origen', 'Peticionario'];

    function PeticionPrevencionController ($timeout, $scope, $stateParams, $uibModalInstance, DataUtils, entity, Peticion, Origen, Peticionario) {
        var vm = this;
